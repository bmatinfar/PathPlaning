      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          // j[1] is the data JSON object
            ...
            for(int i=0; i <sensor_fusion.size(); i++)
            {
                ...
                if(d< (2+4*lane+3) && d>(2+4*lane-3))
                {
                    ...
                    if((check_car_s > car_s) && ((check_car_s-car_s) < 30))
                    {
                        //ref_vel = 29.5;
                        too_close = true;
                        if(lane > 0 && ref_vel<40)
                        {
                            lane = 0;
                        }
                        else if (lane ==0 && ref_vel<40)
                        {
                            lane = 1;
                        }
                    }
            ...
            auto next_mp0 = getXY(car_s+30, (2+4*lane), map_waypoints_s, map_waypoints_x, map_waypoints_y);
            auto next_mp1 = getXY(car_s+60, (2+4*lane), map_waypoints_s, map_waypoints_x, map_waypoints_y);
            auto next_mp2 = getXY(car_s+90, (2+4*lane), map_waypoints_s, map_waypoints_x, map_waypoints_y);
            ...
            for(int i = 0; i < 50; i++)
            {
                ...
                //next_x_vals.push_back(car_y+(dist_inc*i)*sin(deg2rad(car_yaw)));
            }*/
